...
const userService = {
	...
	async list(c, params) {
		...
		// Guard NaN/missing pagination - bare /user/list used to load ALL users
		// then explode D1 with "too many SQL variables" on count joins.
		...
		// Never return password hashes/salts to the browser (admin All Users page)
