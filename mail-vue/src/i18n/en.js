const en = {
    ...
    emailProviderDesc: 'Built-in First: try the built-in email service, fallback to Resend on failure. Resend Only: use Resend exclusively. Built-in Only: use the built-in service only (no fallback).',
    cfFirst: 'Built-in (Resend Fallback)',
    resendOnly: 'Resend Only',
    cfOnly: 'Built-in Only',
    ...
    otherEmailDesc: 'emails can be forwarded to external email, but the destination must be verified first',
    ...
    aiAgentPoweredBy: "Powered by Dev's Mail AI · model:",
